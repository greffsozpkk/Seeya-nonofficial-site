...
function archiveDateLabel(x){
 ...
 const label={"video-published":"영상 게시일",broadcast:"방송일",recording:"녹화일",schedule:"일정표 기준",event:"행사일"}[basis]||(x.dateStatus==="tentative"?"잠정 날짜":"");
 return esc(date)+(x.endDate?" ~ "+esc(x.endDate):"")+(label?" · "+label:"");
}

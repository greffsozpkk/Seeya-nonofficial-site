...
function guide(){
  ...
  <div class="guide-wrap">
    ...
    <section class="guide-step">
      ...
      <div class="guide-actions"><a class="guide-link" href="/music/">전체 디스코그래피 보기 →</a><a class="guide-link" href="/music/stages/">곡별 무대 모아보기 →</a><a class="guide-link" href="/archive/concerts/">콘서트 기록관 보기 →</a></div>
    </section>
    <section class="guide-step">
    ...
    <section class="guide-finish"><div class="eye">WELCOME TO SEEYA</div><h2>이제 준비됐어요.</h2><div class="guide-lines"><span>한 곡을 듣고, 한 장면을 보고, 한 시절을 따라가다 보면</span><span>어느새 당신에게도 씨야의 노래가 하나쯤 남아 있을 거예요.</span></div><div class="guide-actions" style="justify-content:center"><a class="guide-link" href="/today/">오늘의 씨야 만나기 →</a><a class="guide-link" href="/game/lyrics/">가사 퀴즈 도전하기 →</a><a class="guide-link" href="/game/exam/">씨야 모의고사 풀기 →</a></div></section>

...
<section class="home-game"><div class="home-game-copy"><div class="eye">SEEYA · FAN GAME</div><h2>SEEYA PLAY</h2><p>씨야와 함께하는 팬 놀이터<br>가사 보고 제목 맞히기부터 씨야 모의고사까지.<br>씨야와 함께한 기억을 펼쳐보세요.</p><a class="home-game-go" href="/game/">게임 선택하기 →</a></div><div class="home-game-art" aria-hidden="true"><strong>가사 한 줄로<br>제목을 맞혀보세요.<span>135 QUESTIONS · 3 LEVELS</span></strong></div></section>
...
<div class="home-pixel-signoff" aria-label="SEEYA pixel characters">
  ...
  <div class="home-credit home-nonprofit">
    ...
    <a class="creator-letter-link" href="/letter/"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 6 9 7 9-7"/></svg>제작자의 편지</a>

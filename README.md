...
멤버 소개의 사인을 모바일·PC에서 다르게 배치했습니다. 모바일은 프로필 사진과 이름 오른쪽 여백을 크게 활용하고, PC는 이름 오른쪽에 배치합니다. 851~1100px의 좁은 PC 카드에서는 이름 아래로 내려 겹침을 피합니다. v4.92의 아카이브 919건을 모두 유지합니다.

## 이번 업데이트 적용

1. GitHub Desktop에서 **Fetch origin → Pull origin**으로 최신 파일을 받습니다.
2. `SEEYA_v4_93_UPLOAD.zip`의 내용물을 저장소 최상위 폴더에 같은 경로로 복사합니다.
